...
处理问题有正确的工具。当你的 Ruby on Rails 系统需要更强大的web handler时，可以考虑下ruby生态系统之外的技术，或许可以得到更简单但更强大的替代方案。
  ...
  [3]: http://12factor.net/
  [4]: http://marcio.io/img/cloudwatch-console.png
  [5]: http://marcio.io/img/elasticbeanstalk-healthy-hosts.png
  [6]: http://marcio.io/img/elasticbeanstalk-production-dashboard.png